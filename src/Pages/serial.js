...
const Serial = (props) => {
  ...
  console.log("all the serials", props.serials);

  const serial_id = props.match.params.id;
  const serial_url = `https://api.themoviedb.org/3/movie/${movie_id}?api_key=553ff4c7632836ac15fb42f83753edfd&language=en-US`;
  ...
  console.log("the serial I chose", serial);
